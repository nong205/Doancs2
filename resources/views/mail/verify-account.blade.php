                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                    Bạn vừa đăng ký tài khoản trên website của chúng tôi. Nếu đó là bạn xin vui lòng xác nhận.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding: 0 0 24px 0; text-align: center">
                                    <a class="button" href="{{ route('client.verify', $user->remember_token) }}" title="Reset Password" style="width: 40%; background: #4C83EE; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Kích hoạt tài khoản</a>
                                </td>
                            </tr>
